        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              I have developed a strong passion for programming and have gained substantial knowledge in the field.              <br />
          ...
          <Col md={4} className="myAvtar">
            <Tilt>
              <img src={myImg} className="img-fluid" alt="avatar" width={200} />
            </Tilt>
          </Col>
        </Row>
        <Row>
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              ...
              <li className="social-icons">
                <a
                  href="https://www.instagram.com/mahek.chandibhamar"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
                >
